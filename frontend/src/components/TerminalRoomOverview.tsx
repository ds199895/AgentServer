    ...
    <>
      {collapsed ? (
        <button
          ...
          className="absolute top-[72px] right-6 z-[7] grid size-7 cursor-pointer place-items-center rounded-full border border-[#365047] bg-[#06100ed9] shadow-[0_8px_25px_#000a] backdrop-blur-[7px] transition-transform hover:scale-110 max-md:top-[66px] max-md:right-3.5"
        >
      ...
      <div
        ...
        className="absolute top-[72px] right-6 z-[7] aspect-video w-[clamp(190px,20vw,280px)] cursor-zoom-in overflow-hidden rounded-[10px] border border-[#365047] bg-[#05090e] shadow-[0_16px_45px_#000b,0_0_0_1px_#77f2b40c] outline-none transition-[border-color,box-shadow,transform] hover:-translate-y-0.5 hover:border-[#62b58e] hover:shadow-[0_18px_50px_#000d,0_0_0_2px_#77f2b426] focus-visible:-translate-y-0.5 focus-visible:border-[#62b58e] focus-visible:shadow-[0_18px_50px_#000d,0_0_0_2px_#77f2b426] max-md:top-[66px] max-md:right-3.5 max-md:w-[min(190px,46vw)]"
      >
        ...
        <button
          ...
          className="absolute bottom-[7px] right-[38px] z-[6] grid size-[25px] cursor-pointer place-items-center rounded-[7px] border border-[#365047] bg-[#06100ed9] text-[#b9c5ce] shadow-[0_5px_15px_#0008] backdrop-blur-[7px] transition-colors hover:text-primary"
        >
          <Minus className="size-3" />
        </button>
        <span aria-hidden="true" className="pointer-events-none absolute bottom-[7px] right-[7px] z-[5] grid size-[25px] place-items-center rounded-[7px] border border-[#365047] bg-[#06100ed9] text-primary shadow-[0_5px_15px_#0008] backdrop-blur-[7px]">
