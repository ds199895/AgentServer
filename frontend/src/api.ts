...
export const api = {
  ...
  createRuntimeEnrollment: (id: string, options: ApiRequestOptions = {}) =>
  ...
  probeDeviceRuntime: (id: string, options: ApiRequestOptions = {}) =>
    request<{ command: Record<string, unknown> }>(`/api/devices/${encodeURIComponent(id)}/runtime/probe`, {
      method: 'POST',
      body: '{}',
      signal: options.signal,
    }),
  revokeDeviceRuntime: (id: string, options: ApiRequestOptions = {}) =>
